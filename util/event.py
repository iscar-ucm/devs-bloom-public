...
class DataEventColumns:
    ...
    data_columns[DataEventId.POSBLOOM.value] = ["Lat", "Lon", "Depth", "DetB", "DetBb"]
    data_columns[SensorEventId.OXIGEN.value] = ["Time", "Lat", "Lon", "Depth", SensorEventId.OXIGEN.value]
    data_columns[SensorEventId.NITROGEN.value] = ["Time", "Lat", "Lon", "Depth", SensorEventId.NITROGEN.value]
    data_columns[SensorEventId.ALGA.value] = ["Time", "Lat", "Lon", "Depth", SensorEventId.ALGA.value]
    data_columns[SensorEventId.NOX.value] = ["Time", "Lat", "Lon", "Depth", SensorEventId.NOX.value]
    data_columns[SensorEventId.DOX.value] = ["Time", "Lat", "Lon", "Depth", SensorEventId.DOX.value]
    data_columns[SensorEventId.ALG.value] = ["Time", "Lat", "Lon", "Depth", SensorEventId.ALG.value]
    data_columns[SensorEventId.WTE.value] = ["Time", "Lat", "Lon", "Depth", SensorEventId.WTE.value]
    data_columns[SensorEventId.WFU.value] = ["Time", "Lat", "Lon", "Depth", SensorEventId.WFU.value]
    data_columns[SensorEventId.WFV.value] = ["Time", "Lat", "Lon", "Depth", SensorEventId.WFV.value]
    data_columns[SensorEventId.SUN.value] = ["Time", "Lat", "Lon", "Depth", SensorEventId.SUN.value]
    data_columns[SensorEventId.WFX.value] = ["Time", "Lat", "Lon", "Depth", SensorEventId.WFX.value]
    data_columns[SensorEventId.WFY.value] = ["Time", "Lat", "Lon", "Depth", SensorEventId.WFY.value]
    @staticmethod
