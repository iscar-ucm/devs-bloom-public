...
class ModelJournal_V2(Coupled):
    ...
    def __init__(self, name: str, commands_path: str, simbody: SimBody5, log_Time=False, log_Data=False):
        ...
        '''
        cloud_body = Cloud_Sensor(host='http://192.168.137.80')
...
def test_journal_V2():
    ...
    bodyfile: str = './dataedge/Washington-1m-2008-09_UGRID.nc'
    simbody: SimBody5 = SimBody5('SimWater', bodyfile)
    coupled = ModelJournal_V2("ModelJournal_V2", 'data/simulation-journal.txt', simbody, log_Time=True, log_Data=False)
    coord = Coordinator(coupled)
    coord.initialize()
    coord.simulate()
    coord.exit()    