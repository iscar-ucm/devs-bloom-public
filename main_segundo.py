...
from edge.file import FileOut,FileInVar
from edge.body import SimBody3
from util.event import SensorEventId,SensorInfo
...
class Test3(Coupled):
  ...
  def __init__(self, name, simbody, start, log=False):
    ...
    #Sensors telemetries resquet files
...
if __name__ == "__main__":
  ...
  #1 hour simulation to sweep the body (~2 min)
